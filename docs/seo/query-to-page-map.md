...
| VitaeContext CLI commands | `/docs/cli/` | Suitable | Keep synchronized with product 2.0.0 and link each command group to its conceptual guide. | `/docs/installation/`, `/vitaegraph/` | Copy a command. |
